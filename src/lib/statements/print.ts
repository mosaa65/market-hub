...
function renderFooter(
  ...
  const brandBlock = layout.showBrandFooter
    ? `<div class="brand">
        ...
        <img src="${esc(company.brand.logoUrl)}" alt="Inama Soft" />
      </div>`
  ...
  <div class="rpt-foot">
    <div>
      <div>${esc(
        layout.footerNote ||
          (ar
            ? "هذا الكشف أنشئ من النظام ويمكن حفظه كملف PDF من نافذة الطباعة."
            : "This statement was generated by the system and can be saved as PDF."),
      )}</div>
