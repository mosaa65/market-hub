...
export function resolveStatementLayout(options: ResolveLayoutOptions): StatementLayout {
  ...
  return {
    ...
    footerNote:
      settings.footer.footerNote ||
      (lang === "ar"
        ? "هذا الكشف مُنشأ من النظام ويمكن حفظه كملف PDF من نافذة الطباعة."
        : "This statement was generated by the system and can be saved as PDF from the print dialog."),
  };
}
