  ...
  <div class="page">
    ...
    <div class="rpt-head legacy-head">
      <div class="legacy-brand">
        <img class="co-logo" src="${escapeHtml(logoUrl)}" alt="${escapeHtml(company.brand.name)}" />
        <div class="legacy-brand-name">${escapeHtml(company.brand.name)}</div>
      </div>
    ...
    <div class="rpt-foot">
      <div>
        <div style="font-weight:600;margin-top:2px;">Market Hub · ${escapeHtml(company.brand.name)}</div>
      </div>
      <div class="brand">
        <div class="brand-txt" style="text-align:${ar ? "right" : "left"};">
          <b>${escapeHtml(company.brand.name)}</b>
          <div>Mousa Gamil Al-Awadhi - Ibb, Yemen</div>
          <div dir="ltr">inma-soft.vercel.app &nbsp; +967 772 217 218</div>
        </div>
        <img src="/inama-soft-logo.ico" alt="${escapeHtml(company.brand.name)}" />
      </div>
    </div>
  </div>
</body>
