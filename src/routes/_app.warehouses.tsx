      ...
      <div className="panel-elevated overflow-hidden">
        <div className="flex items-center gap-2 border-b border-border p-3">
          ...
          >
            ...
            <span className="hidden sm:inline">{t("warehouses.new")}</span>
          </button>
        </div>
                      ...
                      <div className="inline-flex items-center gap-1">
                        {!r.is_default && (
                          <button
                            ...
                            className="grid h-7 w-7 place-items-center rounded-md border border-border bg-surface text-muted-foreground hover:text-primary transition"
