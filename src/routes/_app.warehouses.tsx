                  ...
                  <tr key={r.id} className="border-b border-border/60 hover:bg-accent/40 transition-colors">
                    ...
                    <td className="px-4 py-2.5 text-end">
                      <div className="inline-flex items-center gap-1">
                        ...
                        <button onClick={() => remove(r.id)} className="grid h-8 w-8 place-items-center rounded-full border border-destructive/30 bg-destructive/5 text-destructive hover:bg-destructive/10 transition" title={t("common.delete")}>
