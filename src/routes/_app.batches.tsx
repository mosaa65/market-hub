      ...
      <div className="panel-elevated p-4">
        <div className="mb-4 flex items-center gap-2">
          ...
          >
            ...
            <span className="hidden sm:inline">{lang === "ar" ? "دفعة جديدة" : "New batch"}</span>
          </button>
        </div>
                  ...
                  return (
                    <tr key={r.id} className="border-b border-border/50 hover:bg-surface-2/50">
                      ...
                      <td className="px-3 py-2.5">
                        <span
                          className={`inline-flex rounded-full border px-2 py-0.5 text-[10px] ${s.cls}`}
                        >
                          {s.label}
                        </span>
                      </td>
                      <td className="px-3 py-2.5 text-end">
                        <button
                          ...
                          className="grid h-8 w-8 place-items-center rounded-full border border-destructive/30 bg-destructive/5 text-destructive hover:bg-destructive/10 transition ms-auto"
                        >
